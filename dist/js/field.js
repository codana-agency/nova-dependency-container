...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	methods: {
		...
		registerDependencyWatchers: function registerDependencyWatchers(root, callback, onMounted) {
			var _this = this;
			...
			root.$children.forEach(function (component) {
				...
				_this.registerDependencyWatchers(component, null, false);
			});
			if (callback !== null) {
				callback.call(this);
			}
		...
		updateDependencyStatus: function updateDependencyStatus() {
			...
			try {
				for (var _iterator2 = this.field.dependencies[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
					...
					// #93 compatability with flexible-content, which adds a generated attribute for each field
					var dependencyValue = this.dependencyValues[attribute];
							...
							try {
								for (var _iterator3 = formData.entries()[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
									...
									if (key == field.attribute) {
										formData.append(_this2.field.attribute + '[' + field.attribute + ']', value);
										formData.delete(key);
									}
								}
							} catch (err) {
